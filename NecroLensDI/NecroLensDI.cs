...
using NecroLensDI.Service;
using NecroLensDI.Windows;
using NecroLensDI.Interface;
using NecroLensDI.Logging;
using Dalamud.Game.Command;
using NecroLensDI.Data;
using System; // Ensure this is referenced

namespace NecroLensDI;

[SuppressMessage("ReSharper", "ClassNeverInstantiated.Global")]
[SuppressMessage("ReSharper", "UnusedType.Global")]
[SuppressMessage("ReSharper", "InconsistentNaming")]
public sealed class NecroLensDI : IDalamudPlugin, IMainUIManager
{
    //Dalamud services
    ...
    public readonly WindowSystem WindowSystem = new("NecroLensDI");

    // Commands
    private const string NecroLensCmd = "/NecroLensDI";
    ...
    public NecroLensDI(IDalamudPluginInterface PluginInterface, IFramework framework)
    {
...
//#endif
        ...
        CommandManager.RemoveHandler("/NecroLensDI");
