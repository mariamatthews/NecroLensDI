...
public class ConfigWindow : Window, IDisposable
{
    ...
    public ConfigWindow(ILoggingService logger, Configuration configuration) : base(Strings.ConfigWindow_Title, ImGuiWindowFlags.AlwaysAutoResize)
    {
        this.logger = logger;
    ...
    private void DrawDebugTab()
    {
        ...
        ImGui.Indent(15);
        ImGui.Text("Help me improve NecroLensDI by enabling data collection.\n" +
