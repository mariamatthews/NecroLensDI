...
using static NecroLensDI.util.DeepDungeonUtil;
    ...
    public void DumpFloorObjects(int currentContentId)
    {
        if (configuration.OptInDataCollection)
        {
            ...
            var collector = new DataCollector
            {
                ...
                Party = NecroLensDI.PartyList.PartyId.ToString(),
            ...
            Task.Factory.StartNew(async () =>
            {
                ...
                try
                {
                    await client.PostAsync("https://NecroLensDI.jusrv.de/api/import2",
